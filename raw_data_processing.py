...
def create_five_sample_extension(data_list):
    ...
    print(f'样本总数为{number/5},AD样本总数为{int(ad_sample_num/5)},HC样本总数为{int(hc_sample_num/5)}')
...
if __name__ == '__main__':
    ...
    number_of_sample=create_five_sample_extension(eeg_list)
    print('共计多少个样本：',number_of_sample)
